...
public class MainActivity extends AppCompatActivity {
    ...
    private void setCategories(){
        ...
        if(categories.size() == 0){ //falls es noch keine Kategorien gibt, diese hier anlegen
            Category category = new Category("Verkehrsmittel", R.color.Verkehrsmittel, 0.0);
            mySQLite.addCategory(category);
            category = new Category("Wohnen", R.color.Wohnen, 0.0);
            mySQLite.addCategory(category);
            category = new Category("Lebensmittel", R.color.Lebensmittel, 0.0);
            mySQLite.addCategory(category);
            category = new Category("Gesundheit",R.color.Gesundheit, 0.0);
            mySQLite.addCategory(category);
            category = new Category("Freizeit", R.color.Freizeit, 0.0);
            mySQLite.addCategory(category);
            category = new Category("Sonstiges", R.color.Sonstiges, 0.0);
            mySQLite.addCategory(category);
        }
    }
