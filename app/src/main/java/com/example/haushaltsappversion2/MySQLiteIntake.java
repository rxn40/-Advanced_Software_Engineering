...
public class MySQLiteIntake extends SQLiteOpenHelper {
    ...
    public void addIntake(Intake intake){
        ...
        db.close();
        Log.d("addCategory", intake.toString());
    }
    ...
    public List<Intake> getMonthIntakes(int day, int month, int year) {
        List<Intake> intakes = new LinkedList<Intake>();
        ...
        if (cursor != null) {
            ...
            if (cursor.moveToFirst()) {
                ...
                do {
                    ...
                    if ("monatlich".equals(cycle) || (Integer.parseInt(cursor.getString(3)) <= day)) {
