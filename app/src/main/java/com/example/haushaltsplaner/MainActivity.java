...
public class MainActivity extends AppCompatActivity {
    ...
    // and PieChart class
    TextView tvAusgaben, tvEinnahmen, tvRestbudget; // warum hier angelegt und warum nicht private?
    PieChart pieChart;
    BarChart mBarChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvEinnahmen = findViewById(R.id.tvEinnahmen); //warum hier?
    ...
    private void getDate(){
        ...
        String dates = datumsformat.format(kalender.getTime());
        day = Integer.parseInt(dates.substring(0,2));
        month = Integer.parseInt(dates.substring(3,5));
        year = Integer.parseInt(dates.substring(6,10));
    }

    //eventuell "Untermethoden" schreiben. Für jede Darstellung eine eigene Methode?
